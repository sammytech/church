...
/***/ function(module, exports, __webpack_require__) {
	...
	var sermons_component_1 = __webpack_require__(786);
	exports.Sermons = sermons_component_1.Sermons;
	var index_component_1 = __webpack_require__(782);
	exports.Index = index_component_1.Index;
	var outline_component_1 = __webpack_require__(783);
	exports.Outline = outline_component_1.Outline;
	var reading_component_1 = __webpack_require__(785);
	exports.Reading = reading_component_1.Reading;
	var podcast_component_1 = __webpack_require__(784);
	exports.Podcast = podcast_component_1.Podcast;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatePicker = (function () {
	    ...
	    DatePicker = __decorate([
	        ...
	        __metadata('design:paramtypes', [(typeof (_b = typeof common_1.NgModel !== 'undefined' && common_1.NgModel) === 'function' && _b) || Object, (typeof (_c = typeof core_1.ViewContainerRef !== 'undefined' && core_1.ViewContainerRef) === 'function' && _c) || Object])
	    ], DatePicker);
	    return DatePicker;
	    var _a, _b, _c;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Outline = (function () {
	    ...
	    Outline.prototype.ngOnInit = function () {
	        console.log('hello `Outline` component');
	    };
	    Outline = __decorate([
	        core_1.Component({
	            selector: 'outline',
	            styles: [__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./outline.style.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var podcast_service_1 = __webpack_require__(890);
	var Podcast = (function () {
	    function Podcast(appState, podService) {
	        this.appState = appState;
	        this.podService = podService;
	        this.podcasts = podService.get(0, 10);
	    }
	    Podcast.prototype.playPodcast = function () {
	        if (!this.appState.state.visible) {
	            this.appState.set('visible', true);
	        }
	    };
	    Podcast.prototype.ngOnInit = function () {
	        console.log('hello `Podcast` component');
	    };
	    Podcast = __decorate([
	        core_1.Component({
	            selector: 'podcast',
	            styles: [__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./podcast.style.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))],
	            template: __webpack_require__(898),
	            providers: [podcast_service_1.Podcasts]
	        }), 
	        __metadata('design:paramtypes', [(typeof (_a = typeof app_service_1.AppState !== 'undefined' && app_service_1.AppState) === 'function' && _a) || Object, (typeof (_b = typeof podcast_service_1.Podcasts !== 'undefined' && podcast_service_1.Podcasts) === 'function' && _b) || Object])
	    ], Podcast);
	    return Podcast;
	    var _a, _b;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(1);
	var common_1 = __webpack_require__(34);
	var ng2_datepicker_1 = __webpack_require__(888);
	var Reading = (function () {
	    function Reading() {
	        this.calendar = new Array(35);
	        this.month = "";
	        this.monthNumber = new Date().getMonth();
	        this.year = new Date().getFullYear();
	        // console.log(this.calendar);
	        this.calendar = this.getDaysArray(this.monthNumber);
	        this.month = this.getMonth(this.monthNumber);
	        // console.log(this.calendar);
	    }
	    Reading.prototype.getMonth = function (month) {
	        var monthNames = ["January", "February", "March", "April", "May", "June",
	            "July", "August", "September", "October", "November", "December"
	        ];
	        return monthNames[month];
	    };
	    Reading.prototype.prevMonth = function () {
	    ...
	    Reading.prototype.nextMonth = function () {
	    ...
	    Reading.prototype.getDaysArray = function (month) {
	        var names = ['sun', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat'];
	        var currentDate = new Date();
	        var date = new Date(currentDate.getFullYear(), month, 1);
	        var result = [];
	        var tempWeek = new Array(7);
	        while (date.getMonth() == month) {
	            if (date.getDate() == currentDate.getDate() && date.getMonth() == currentDate.getMonth()) {
	                tempWeek[date.getDay()] = { date: date.getDate(), current: true };
	            }
	            else {
	                tempWeek[date.getDay()] = { date: date.getDate() };
	            }
	            if (date.getDay() == 6) {
	                result.push(tempWeek);
	                // console.log(tempWeek);
	                tempWeek = new Array(7);
	            }
	            // result.push(date.getDate()+"-"+names[date.getDay()]);
	            date.setDate(date.getDate() + 1);
	        }
	        var size = tempWeek.filter(function (value) { return value !== undefined; }).length;
	        if (size > 0) {
	            // console.log(tempWeek);
	            result.push(tempWeek);
	        }
	    ...
	    Reading.prototype.ngOnInit = function () {
	        console.log('hello `Reading` component');
	    };
	    Reading = __decorate([
	        core_1.Component({
	            selector: 'reading',
	            //styles: [require('./reading.style.css')],
	            styles: [__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./reading.style.css\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))],
	            template: __webpack_require__(899),
	            directives: [ng2_datepicker_1.DatePicker, common_1.FORM_DIRECTIVES, common_1.CORE_DIRECTIVES]
	        }), 
	        __metadata('design:paramtypes', [])
	    ], Reading);
	    return Reading;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sermons = (function () {
	    ...
	    Sermons.prototype.ngOnInit = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (global, factory) {
	    true ? factory(__webpack_require__(775)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ng2_datepicker_1 = __webpack_require__(776);
	...
	var Podcasts = (function () {
	    function Podcasts() {
	        ...
	        this._podcast = [{
	                ...
	                "date": "7/15/2016",
	                "audio_link": "https://github.com/vulputate/nonummy.aspx",
	                "length": 21.66,
	                ...
	                "title": "In congue.",
	                "date": "3/6/2016",
	                "outline_link": "https://godaddy.com/aliquam.json",
	                "audio_link": "https://bbb.org/orci/nullam/molestie/nibh.xml",
	                "length": 32.51,
	                ...
	                "title": "Nulla ac enim.",
	                "date": "11/10/2015",
	                "outline_link": "http://shareasale.com/donec/odio/justo/sollicitudin/ut/suscipit.png",
	                "audio_link": "http://mozilla.org/duis/mattis.aspx",
	                "length": 11.07,
	                ...
	                "title": "Nulla tempus.",
	                "date": "2/9/2016",
	                "outline_link": "https://google.fr/tortor/id/nulla/ultrices.jsp",
	                "audio_link": "http://twitter.com/quisque/arcu/libero/rutrum/ac/lobortis/vel.json",
	                "length": 25.49,
	                ...
	                "date": "11/30/2015",
	                "outline_link": "https://sbwire.com/proin/interdum/mauris/non.js",
	                "audio_link": "http://aol.com/cubilia/curae.aspx",
	                "length": 16.57,
	                ...
	                "date": "2/8/2016",
	                "audio_link": "https://cisco.com/eleifend/donec.xml",
	                "length": 32.2,
	                ...
	                "date": "11/16/2015",
	                "audio_link": "https://webs.com/risus/semper/porta/volutpat/quam/pede/lobortis.xml",
	                "length": 13.85,
	                ...
	                "date": "6/3/2016",
	                "outline_link": "http://diigo.com/molestie/sed/justo/pellentesque/viverra.jpg",
	                "audio_link": "https://archive.org/in/blandit/ultrices.png",
	                "length": 26.15,
	                ...
	                "date": "11/23/2015",
	                "outline_link": "https://wikimedia.org/nulla/mollis/molestie/lorem/quisque/ut.aspx",
	                "audio_link": "http://google.com.br/mauris/viverra/diam/vitae/quam.jsp",
	                "length": 38.94,
	                ...
	                "date": "5/3/2016",
	                "outline_link": "https://wikimedia.org/nibh/in/quis/justo/maecenas.jpg",
	                "audio_link": "http://addthis.com/in/leo/maecenas/pulvinar/lobortis.html",
	                "length": 36.18,
	                ...
	                "date": "6/17/2016",
	                "audio_link": "http://upenn.edu/sapien.jsp",
	                "length": 33.48,
	                ...
	                "date": "6/27/2016",
	                "outline_link": "http://de.vu/ipsum.jpg",
	                "audio_link": "http://deliciousdays.com/placerat.xml",
	                "length": 36.32,
	                ...
	                "date": "5/31/2016",
	                "audio_link": "https://over-blog.com/nisi/vulputate/nonummy/maecenas/tincidunt.json",
	                "length": 40.0,
	                ...
	                "date": "8/26/2015",
	                "outline_link": "http://wordpress.com/tempor/convallis.json",
	                "audio_link": "https://apple.com/nisl.png",
	                "length": 24.24,
	                ...
	                "date": "5/13/2016",
	                "audio_link": "https://cdc.gov/nisi.png",
	                "length": 35.96,
	                ...
	                "date": "5/16/2016",
	                "audio_link": "https://admin.ch/maecenas/leo/odio/condimentum.xml",
	                "length": 25.62,
	                ...
	                "date": "11/6/2015",
	                "outline_link": "http://japanpost.jp/erat.jpg",
	                "audio_link": "https://dot.gov/nec/nisi/volutpat/eleifend.png",
	                "length": 18.41,
	                ...
	                "date": "2/3/2016",
	                "outline_link": "https://mlb.com/cubilia.png",
	                "audio_link": "https://diigo.com/pede/lobortis.html",
	                "length": 15.12,
	                "description": "Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus. Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam."
	            }, {
	                "id": 19,
	                "title": "In hac habitasse platea dictumst.",
	                "date": "11/25/2015",
	                "audio_link": "http://tmall.com/leo/odio/porttitor/id.js",
	                "length": 12.9,
	                ...
	                "date": "1/12/2016",
	                "outline_link": "http://nationalgeographic.com/in/lacus/curabitur/at/ipsum/ac/tellus.aspx",
	                "audio_link": "https://mozilla.org/consequat/in/consequat/ut/nulla.json",
	                "length": 34.42,
	                ...
	                "title": "Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa.",
	                "date": "2/19/2016",
	                "audio_link": "http://walmart.com/sit/amet/erat/nulla/tempus/vivamus/in.html",
	                "length": 34.52,
	                ...
	                "title": "Mauris sit amet eros.",
	                "date": "12/20/2015",
	                "outline_link": "https://sogou.com/eget/rutrum/at.json",
	                "audio_link": "http://studiopress.com/eros/suspendisse/accumsan/tortor/quis/turpis/sed.jsp",
	                "length": 22.3,
	                ...
	                "title": "Sed ante.",
	                "date": "10/18/2015",
	                "audio_link": "http://uol.com.br/erat/id/mauris/vulputate/elementum/nullam/varius.html",
	                "length": 18.98,
	                ...
	                "title": "Nulla justo.",
	                "date": "12/14/2015",
	                "audio_link": "https://jalbum.net/lectus/in/quam/fringilla/rhoncus/mauris/enim.png",
	                "length": 29.08,
	                ...
	                "date": "9/20/2015",
	                "audio_link": "http://si.edu/orci/eget/orci/vehicula/condimentum/curabitur.js",
	                "length": 33.16,
	                ...
	                "date": "2/7/2016",
	                "outline_link": "https://merriam-webster.com/eu.jsp",
	                "audio_link": "http://chron.com/vestibulum/ante/ipsum/primis/in/faucibus.html",
	                "length": 18.97,
	                ...
	                "date": "7/19/2016",
	                "audio_link": "https://globo.com/consequat/metus.png",
	                "length": 14.87,
	                ...
	                "date": "12/20/2015",
	                "audio_link": "https://about.me/nibh/in.html",
	                "length": 37.68,
	                ...
	                "date": "11/14/2015",
	                "outline_link": "http://tripod.com/blandit/mi/in/porttitor/pede/justo.png",
	                "audio_link": "http://alexa.com/in/lectus.png",
	                "length": 34.96,
	                ...
	                "title": "Ut tellus.",
	                "date": "3/20/2016",
	                "audio_link": "http://ebay.com/amet/diam/in/magna.js",
	                "length": 30.64,
	                ...
	                "date": "11/17/2015",
	                "outline_link": "http://blogger.com/dapibus/at/diam.json",
	                "audio_link": "http://nih.gov/accumsan/odio/curabitur/convallis/duis/consequat.html",
	                "length": 37.64,
	                ...
	                "date": "6/8/2016",
	                "audio_link": "http://chronoengine.com/turpis/a/pede.html",
	                "length": 34.02,
	                ...
	                "date": "6/17/2016",
	                "audio_link": "http://examiner.com/in/hac/habitasse/platea/dictumst/etiam/faucibus.json",
	                "length": 18.45,
	                ...
	                "date": "12/16/2015",
	                "audio_link": "https://php.net/donec/odio/justo/sollicitudin.jsp",
	                "length": 24.23,
	                ...
	                "date": "10/21/2015",
	                "audio_link": "http://gizmodo.com/molestie/nibh/in/lectus.html",
	                "length": 34.79,
	                ...
	                "title": "In blandit ultrices enim.",
	                "date": "11/10/2015",
	                "outline_link": "https://shop-pro.jp/integer/pede.xml",
	                "audio_link": "http://mayoclinic.com/quis.js",
	                "length": 27.27,
	                ...
	                "date": "1/20/2016",
	                "outline_link": "https://xing.com/integer.html",
	                "audio_link": "http://constantcontact.com/nisl/duis/bibendum.png",
	                "length": 39.6,
	                ...
	                "date": "4/29/2016",
	                "audio_link": "https://ucoz.com/mattis/nibh/ligula/nec/sem/duis/aliquam.jpg",
	                "length": 27.38,
	                ...
	                "date": "6/24/2016",
	                "outline_link": "https://themeforest.net/mauris/vulputate.js",
	                "audio_link": "http://domainmarket.com/consequat.xml",
	                "length": 27.37,
	                ...
	                "date": "8/4/2015",
	                "outline_link": "http://tumblr.com/justo/in.xml",
	                "audio_link": "http://dagondesign.com/quis/tortor.xml",
	                "length": 30.96,
	                ...
	                "title": "Proin eu mi.",
	                "date": "6/23/2016",
	                "audio_link": "https://reddit.com/justo/nec/condimentum/neque/sapien/placerat.jpg",
	                "length": 16.26,
	                ...
	                "title": "Nulla ac enim.",
	                "date": "6/28/2016",
	                "outline_link": "https://usatoday.com/sed/nisl/nunc/rhoncus/dui/vel/sem.json",
	                "audio_link": "http://blogger.com/laoreet/ut/rhoncus.jpg",
	                "length": 29.77,
	                ...
	                "date": "9/17/2015",
	                "outline_link": "https://bing.com/nulla/tempus/vivamus.jpg",
	                "audio_link": "http://hud.gov/lorem/vitae/mattis/nibh/ligula/nec.png",
	                "length": 14.75,
	                ...
	                "date": "5/26/2016",
	                "audio_link": "http://bizjournals.com/enim/leo.json",
	                "length": 12.77,
	                ...
	                "title": "Proin eu mi.",
	                "date": "1/4/2016",
	                "audio_link": "http://blogs.com/pellentesque/quisque/porta.js",
	                "length": 38.46,
	                ...
	                "date": "10/22/2015",
	                "audio_link": "https://archive.org/morbi/vel/lectus/in/quam/fringilla/rhoncus.json",
	                "length": 16.34,
	                ...
	                "date": "6/7/2016",
	                "audio_link": "https://nifty.com/in/porttitor/pede/justo/eu/massa/donec.xml",
	                "length": 31.13,
	                ...
	                "date": "6/15/2016",
	                "outline_link": "http://spiegel.de/dolor/vel/est/donec/odio.jsp",
	                "audio_link": "https://123-reg.co.uk/nam/nulla/integer/pede/justo.json",
	                "length": 37.5,
	                ...
	                "date": "1/11/2016",
	                "audio_link": "https://latimes.com/orci/luctus/et/ultrices.json",
	                "length": 39.57,
	                ...
	                "date": "7/9/2016",
	                "outline_link": "https://omniture.com/integer/ac/leo/pellentesque/ultrices.html",
	                "audio_link": "https://opera.com/sem/sed/sagittis/nam/congue.jpg",
	                "length": 18.88,
	                ...
	                "title": "In sagittis dui vel nisl.",
	                "date": "2/28/2016",
	                "outline_link": "http://cbslocal.com/metus/vitae/ipsum.jsp",
	                "audio_link": "http://cloudflare.com/odio/curabitur/convallis.xml",
	                "length": 23.01,
	                "description": "Donec ut mauris eget massa tempor convallis. Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh. Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros. Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue."
	            }, {
	                "id": 52,
	                ...
	                "date": "4/4/2016",
	                "outline_link": "http://geocities.com/nulla/suscipit/ligula/in/lacus/curabitur/at.js",
	                "audio_link": "http://goo.gl/elementum/nullam/varius/nulla.json",
	                "length": 25.38,
	                ...
	                "title": "Nullam varius.",
	                "date": "3/24/2016",
	                "outline_link": "https://nature.com/dui/maecenas.js",
	                "audio_link": "https://npr.org/pede/ullamcorper/augue/a/suscipit/nulla.html",
	                "length": 30.98,
	                ...
	                "date": "5/7/2016",
	                "audio_link": "https://hubpages.com/dictumst.html",
	                "length": 33.55,
	                ...
	                "date": "6/9/2016",
	                "audio_link": "https://nsw.gov.au/congue/etiam/justo/etiam.html",
	                "length": 24.49,
	                ...
	                "title": "Vivamus vel nulla eget eros elementum pellentesque.",
	                "date": "10/28/2015",
	                "outline_link": "https://amazon.co.jp/in/felis/donec/semper/sapien/a.json",
	                "audio_link": "http://gov.uk/lectus/pellentesque/at/nulla.jsp",
	                "length": 38.58,
	                ...
	                "date": "8/30/2015",
	                "audio_link": "https://squidoo.com/vitae/mattis/nibh/ligula/nec/sem/duis.xml",
	                "length": 32.22,
	                ...
	                "date": "3/14/2016",
	                "outline_link": "http://google.de/in/lectus/pellentesque/at/nulla/suspendisse.png",
	                "audio_link": "http://cbc.ca/turpis/nec/euismod/scelerisque/quam.jsp",
	                "length": 24.06,
	                ...
	                "date": "6/25/2016",
	                "outline_link": "https://histats.com/cras/non/velit/nec/nisi/vulputate/nonummy.json",
	                "audio_link": "http://hatena.ne.jp/blandit/lacinia/erat/vestibulum.html",
	                "length": 21.61,
	                ...
	                "date": "9/18/2015",
	                "audio_link": "http://typepad.com/blandit/mi/in/porttitor.jsp",
	                "length": 39.43,
	                ...
	                "date": "6/16/2016",
	                "audio_link": "http://fema.gov/ornare/consequat/lectus/in.json",
	                "length": 38.02,
	                ...
	                "title": "Curabitur in libero ut massa volutpat convallis.",
	                "date": "3/8/2016",
	                "audio_link": "http://surveymonkey.com/lacus/at/turpis.xml",
	                "length": 30.73,
	                ...
	                "title": "Nam nulla.",
	                "date": "1/24/2016",
	                "outline_link": "http://amazon.com/suscipit/nulla/elit/ac/nulla.png",
	                "audio_link": "http://freewebs.com/vulputate/elementum.jpg",
	                "length": 25.78,
	                ...
	                "title": "Fusce consequat.",
	                "date": "3/6/2016",
	                "outline_link": "http://chron.com/convallis/nulla/neque.json",
	                "audio_link": "http://webeden.co.uk/lacus/morbi/quis/tortor/id/nulla.json",
	                "length": 13.53,
	                "description": "Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero. Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh. In quis justo. Maecenas rhoncus aliquam lacus."
	            }, {
	                "id": 65,
	                ...
	                "date": "6/1/2016",
	                "outline_link": "https://reddit.com/elit/proin/risus/praesent.aspx",
	                "audio_link": "https://unblog.fr/sapien/cum/sociis/natoque/penatibus/et/magnis.xml",
	                "length": 33.4,
	                ...
	                "date": "8/23/2015",
	                "outline_link": "http://ibm.com/magna/at.jpg",
	                "audio_link": "https://sina.com.cn/fusce/consequat/nulla/nisl/nunc/nisl.aspx",
	                "length": 22.0,
	                ...
	                "date": "12/15/2015",
	                "outline_link": "http://php.net/massa/id.png",
	                "audio_link": "http://theguardian.com/pulvinar/lobortis/est.json",
	                "length": 27.22,
	                ...
	                "date": "6/28/2016",
	                "outline_link": "https://constantcontact.com/integer/ac/neque/duis/bibendum/morbi.json",
	                "audio_link": "http://admin.ch/at/vulputate.jpg",
	                "length": 38.71,
	                ...
	                "title": "Aenean fermentum.",
	                "date": "5/4/2016",
	                "outline_link": "https://i2i.jp/in.jsp",
	                "audio_link": "https://sourceforge.net/turpis/adipiscing/lorem/vitae/mattis/nibh.aspx",
	                "length": 23.79,
	                ...
	                "title": "Integer ac leo.",
	                "date": "10/24/2015",
	                "outline_link": "http://last.fm/et/ultrices/posuere.png",
	                "audio_link": "http://uol.com.br/in/tempus/sit/amet/sem/fusce.xml",
	                "length": 15.24,
	                ...
	                "title": "Integer non velit.",
	                "date": "12/10/2015",
	                "outline_link": "http://flickr.com/risus/semper/porta.json",
	                "audio_link": "http://bbc.co.uk/quam/suspendisse/potenti/nullam/porttitor/lacus/at.png",
	                "length": 37.78,
	                ...
	                "title": "Ut tellus.",
	                "date": "6/4/2016",
	                "audio_link": "https://usnews.com/integer/ac.jsp",
	                "length": 14.26,
	                "description": "Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat. Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede. Morbi porttitor lorem id ligula."
	            }, {
	                "id": 73,
	                "title": "Nam nulla.",
	                "date": "10/1/2015",
	                "outline_link": "https://hubpages.com/tortor/sollicitudin.png",
	                "audio_link": "https://webnode.com/tempor.png",
	                "length": 23.2,
	                ...
	                "title": "Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante.",
	                "date": "5/12/2016",
	                "audio_link": "http://soundcloud.com/sit/amet/nunc/viverra.png",
	                "length": 36.04,
	                ...
	                "title": "Nulla tempus.",
	                "date": "10/9/2015",
	                "audio_link": "http://chicagotribune.com/etiam/justo/etiam/pretium/iaculis.json",
	                "length": 15.38,
	                ...
	                "date": "3/23/2016",
	                "outline_link": "http://themeforest.net/maecenas/ut.jpg",
	                "audio_link": "http://oracle.com/cras/in/purus.aspx",
	                "length": 28.63,
	                ...
	                "date": "6/6/2016",
	                "audio_link": "http://hugedomains.com/orci/luctus.jpg",
	                "length": 24.58,
	                ...
	                "title": "Donec ut dolor.",
	                "date": "5/31/2016",
	                "audio_link": "http://nps.gov/sapien/sapien/non/mi/integer.json",
	                "length": 26.14,
	                ...
	                "date": "9/14/2015",
	                "outline_link": "http://washington.edu/nunc/commodo/placerat/praesent/blandit.xml",
	                "audio_link": "http://barnesandnoble.com/tortor/quis.html",
	                "length": 25.71,
	                "description": "Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem. Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat. Praesent blandit."
	            }, {
	                "id": 80,
	                "title": "Curabitur convallis.",
	                "date": "5/17/2016",
	                "outline_link": "http://economist.com/a.json",
	                "audio_link": "http://usa.gov/non/velit/donec/diam/neque/vestibulum/eget.js",
	                "length": 31.96,
	                ...
	                "title": "Donec ut dolor.",
	                "date": "11/5/2015",
	                "outline_link": "https://mapy.cz/erat.aspx",
	                "audio_link": "http://moonfruit.com/amet/nunc/viverra.js",
	                "length": 29.41,
	                ...
	                "date": "10/25/2015",
	                "audio_link": "http://behance.net/semper/porta/volutpat/quam/pede/lobortis/ligula.xml",
	                "length": 27.18,
	                ...
	                "date": "11/11/2015",
	                "audio_link": "https://bandcamp.com/adipiscing.html",
	                "length": 29.17,
	                ...
	                "date": "1/22/2016",
	                "outline_link": "http://oakley.com/enim/sit/amet/nunc/viverra.jsp",
	                "audio_link": "https://g.co/pede/venenatis/non/sodales/sed/tincidunt/eu.js",
	                "length": 29.13,
	                ...
	                "date": "7/14/2016",
	                "audio_link": "http://cam.ac.uk/vel.html",
	                "length": 25.9,
	                "description": "Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem. Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio. Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin interdum mauris non ligula pellentesque ultrices."
	            }, {
	                "id": 86,
	                "title": "Suspendisse potenti.",
	                "date": "7/12/2016",
	                "outline_link": "https://jiathis.com/condimentum/neque/sapien/placerat/ante/nulla/justo.png",
	                "audio_link": "https://jugem.jp/vestibulum/quam/sapien/varius.xml",
	                "length": 23.36,
	                ...
	                "date": "4/10/2016",
	                "audio_link": "http://cloudflare.com/sit.png",
	                "length": 16.96,
	                ...
	                "date": "9/26/2015",
	                "audio_link": "https://sourceforge.net/nisi/nam/ultrices.aspx",
	                "length": 30.19,
	                ...
	                "title": "Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.",
	                "date": "12/17/2015",
	                "outline_link": "http://cnbc.com/nulla/justo/aliquam.xml",
	                "audio_link": "https://biglobe.ne.jp/nonummy.aspx",
	                "length": 33.42,
	                "description": "Cras pellentesque volutpat dui. Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti. Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris. Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis."
	            }, {
	                "id": 90,
	                ...
	                "date": "11/7/2015",
	                "outline_link": "http://telegraph.co.uk/nisi/volutpat/eleifend/donec.xml",
	                "audio_link": "http://cornell.edu/risus/praesent/lectus.js",
	                "length": 20.78,
	                "description": "Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede. Morbi porttitor lorem id ligula. Suspendisse ornare consequat lectus. In est risus, auctor sed, tristique in, tempus sit amet, sem. Fusce consequat. Nulla nisl. Nunc nisl. Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa."
	            }, {
	                "id": 91,
	                ...
	                "date": "3/28/2016",
	                "outline_link": "http://digg.com/tempus/vivamus/in/felis/eu/sapien/cursus.jsp",
	                "audio_link": "https://bandcamp.com/bibendum/morbi/non.js",
	                "length": 38.79,
	                ...
	                "title": "Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo.",
	                "date": "9/2/2015",
	                "audio_link": "http://wufoo.com/odio/cras/mi.json",
	                "length": 17.98,
	                "description": "Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem. Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus. Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."
	            }, {
	                "id": 93,
	                "title": "Pellentesque eget nunc.",
	                "date": "5/1/2016",
	                "audio_link": "http://foxnews.com/sapien/arcu/sed.jsp",
	                "length": 13.45,
	                ...
	                "date": "4/7/2016",
	                "audio_link": "http://printfriendly.com/sem/fusce/consequat/nulla.js",
	                "length": 21.04,
	                ...
	                "title": "Suspendisse potenti.",
	                "date": "8/23/2015",
	                "outline_link": "https://godaddy.com/justo/in/hac/habitasse/platea.png",
	                "audio_link": "http://smh.com.au/volutpat/dui/maecenas/tristique/est/et.jsp",
	                "length": 22.46,
	                ...
	                "date": "9/21/2015",
	                "outline_link": "http://ovh.net/luctus/et/ultrices/posuere/cubilia/curae.jsp",
	                "audio_link": "http://squarespace.com/sapien/a/libero/nam/dui/proin/leo.jpg",
	                "length": 31.01,
	                "description": "Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit. Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque. Duis bibendum."
	            }, {
	                "id": 97,
	                "title": "In hac habitasse platea dictumst.",
	                "date": "11/3/2015",
	                "outline_link": "https://usda.gov/tempus/sit/amet/sem.js",
	                "audio_link": "http://storify.com/feugiat/et/eros/vestibulum/ac.jpg",
	                "length": 14.93,
	                ...
	                "title": "Donec dapibus.",
	                "date": "8/6/2015",
	                "audio_link": "http://networkadvertising.org/at/turpis/donec/posuere/metus/vitae/ipsum.json",
	                "length": 21.58,
	                ...
	                "date": "12/8/2015",
	                "audio_link": "http://nps.gov/sapien/cum.png",
	                "length": 32.4,
	                ...
	                "title": "Aliquam erat volutpat.",
	                "date": "11/29/2015",
	                "outline_link": "https://mozilla.org/tincidunt/lacus/at/velit/vivamus/vel/nulla.html",
	                "audio_link": "https://macromedia.com/in/lectus/pellentesque.aspx",
	                "length": 17.81,
	                "description": "Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem. Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio. Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo."
	            }];
	    }
	    Podcasts.prototype.get = function (start, end) {
	        if (end > this._podcast.length) {
	            end = this._podcast.length;
	        }
	        return this._podcast.slice(start, end);
	    };
	    Podcasts = __decorate([
	        core_1.Injectable(), 
	        __metadata('design:paramtypes', [])
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.routes = {
	    path: 'sermons', component: sermons_component_1.Sermons,
	    children: [
	        { path: '', component: index_component_1.Index },
	        { path: 'outline', component: outline_component_1.Outline },
	        { path: 'reading', component: reading_component_1.Reading },
	        { path: 'podcast', component: podcast_component_1.Podcast }
	    ]
	};
...
/***/ function(module, exports) {
	...
	module.exports = " <div id=\"podcast\" class=\"page-header\">\n        <h1 id=\"page-header\" class=\"animated bounceIn\">PODCAST</h1>\n    </div>\n    <div class=\"col-lg-12 main\">\n        <div *ngFor=\"let podcast of podcasts\" class=\"container podcast\">\n            <div class=\"date\">\n                {{podcast.date | date}}\n            </div>\n            <div class=\"title\">\n                {{podcast.title}}\n            </div>\n            <div class=\"description\">\n                {{podcast.description}}\n            </div>\n            <div>\n                <div class=\"btn btn-default listen-podcast\" (click) = \"playPodcast()\"><i class=\"fa fa-play \"></i> &nbsp; Listen • {{podcast.length}}</div>\n                <div *ngIf=\"podcast.outline_link\" class=\"btn btn-default listen-podcast\"><i class=\"fa fa-book \"></i> &nbsp; Outline</div>\n            </div>\n        </div>\n    </div>"
...
/***/ function(module, exports) {
	...
	module.exports = " <div id=\"reading\" class=\"page-header\">\n        <h1 id=\"page-header\" class=\"animated bounceIn\">BIBLE READING</h1>\n    </div>\n    <div class=\"col-lg-12 col-md-12 col-sm-12 main\">\n        <div class=\"calendar\">\n            <div class=\"calendar-heading\">\n                <i [class.active] =\"(monthNumber > 0)\" class=\"ion-arrow-left-a prev-month\" (click)=\"prevMonth()\"></i>\n                <div class=\"calendar-month\">{{month}}</div>\n                <div class=\"calendar-year\">&nbsp;{{year}}</div>\n                <i [class.active] =\"monthNumber < 11\" class=\"ion-arrow-right-a next-month\" (click)=\"nextMonth()\"></i>\n            </div>\n            <div class=\"calendar-day-week\">\n                <div>Sun</div>\n                <div>Mon</div>\n                <div>Tue</div>\n                <div>Wed</div>\n                <div>Thu</div>\n                <div>Fri</div>\n                <div>Sat</div>\n            </div>\n            <div class=\"calendar-body clear\">\n                <div *ngFor = \"let week of calendar\" class=\"calendar-week\">\n                    <div *ngFor = \"let day of week\" class=\"calendar-day\" [class.current] = \"day && day.current\">\n                        <div *ngIf=\"day\" class=\"number\">{{day.date}}</div>\n                        <div *ngIf=\"day\" class=\"reading\"><span>Hebrews 3: 10</span></div>\n                    </div>\n                    <!--<div class=\"calendar-day\">\n                    </div>\n                    <div class=\"calendar-day\">\n                    </div>\n                    <div class=\"calendar-day\">\n                    </div>\n                    <div class=\"calendar-day\">\n                    </div>\n                    <div class=\"calendar-day\">\n                    </div>\n                    <div class=\"calendar-day\">\n                    </div>-->\n                </div>\n                 \n            </div>\n        </div>\n\n    </div>"
